...
public class ConditionData extends Testbase{

	public ConditionData() throws Throwable {
		super();
	}
    //add new
	...
	//back
	public ConditionData(WebDriver driver)throws Throwable
	{
		PageFactory.initElements(driver,this);
	}
	 JavascriptExecutor jse=(JavascriptExecutor)driver;
	public  ConditionData addCondition() throws Throwable {
		 
		 jse.executeScript("arguments[0].click()",addnew);
		return new ConditionData();
		 
	}
	public ConditionData editCondition(String Conditionname) throws Throwable
	{
		search.sendKeys(Conditionname);
		 jse.executeScript("arguments[0].click()",edit);
		return new ConditionData();	
	}
	public ConditionData deleteCondition(String changedcname) throws Throwable
	{
	...
	public ConditionData verify(String changedcname) throws Throwable
	{
		search.sendKeys(changedcname);
